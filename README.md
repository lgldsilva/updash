...
**Cleanup:** brew/apt/go/npm/snap caches, Docker prune (age-filtered), SDKMAN old majors, Antigravity/VS Code extension dupes, Windows TEMP, **homelab retention** (maven/gradle caches, AI tool outputs, host logs, container log truncate, disk-pressure prune).
...
| `UPDASH_DOCKER_BUILDER_MAX_AGE` | `336h` | builder prune |
